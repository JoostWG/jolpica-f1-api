...
import { AverageSpeedApiData, LocationApiData, CircuitApiData, ConstructorApiData, DriverStandingApiData, DateTimeApiData, RaceApiData, TimingApiData, LapApiData, PitStopApiData, QualifyingResultApiData, FastestLapTimeApiData, FastestLapApiData, FinishingTimeApiData, ResultApiData, SeasonApiData, SprintResultApiData, StatusApiData, DriverApiData, ConstructorStandingApiData } from './types/api/data.d.js';
import { Validator } from './validation/types.d.js';
...
declare class PendingRequest<TData extends AnyModel[], TResource extends ModelsKey<TData[number]> = ModelsKey<TData[number]>, TModel extends ModelsMap[TResource] = ModelsMap[TResource]> {
    ...
    constructor(api: Api, resource: TResource, options: AnyApiOptions, transform: (data: ResponsesMap[TResource]['MRData']) => TModel[], validate: Validator<ResponsesMap[TResource]>);
    /**
     * @since 3.0.0
     */
    get url(): string;
