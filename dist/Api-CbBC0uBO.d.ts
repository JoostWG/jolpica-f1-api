...
import { CircuitsResponse, LocationApiData, CircuitApiData } from './types/api/circuit.d.js';
import { AverageSpeedApiData, Pagination, FastestLapTimeApiData, FastestLapApiData, FinishingTimeApiData, SuccessResponse, BadRequestResponse } from './types/api/common.d.js';
import { ConstructorsResponse, ConstructorApiData } from './types/api/constructor.d.js';
import { DriverStandingsResponse, DriverStandingApiData } from './types/api/driver-standing.d.js';
import { RacesResponse, DateTimeApiData, RaceApiData } from './types/api/race.d.js';
import { LapsResponse, TimingApiData, LapApiData } from './types/api/lap.d.js';
import { PitStopsResponse, PitStopApiData } from './types/api/pit-stop.d.js';
import { QualifyingResultsResponse, QualifyingResultApiData } from './types/api/qualifying-result.d.js';
import { ResultsResponse, ResultApiData } from './types/api/result.d.js';
import { SeasonsResponse, SeasonApiData } from './types/api/season.d.js';
import { SprintResultsResponse, SprintResultApiData } from './types/api/sprint-result.d.js';
import { SeasonOption, RoundOption, CircuitOption, DriverOption, TeamOption, LapOption, PitStopOption, FastestRankOption, GridPositionOption, FinishPositionOption, StatusOption, DriverStandingOption, QualifyingResultOption, TeamStandingOption, CircuitOptions, DriverStandingOptions, LapOptions, PitStopOptions, QualifyingResultOptions, RaceOptions, ResultOptions, SeasonOptions, SprintResultOptions, TeamOptions, DriverOptions, TeamStandingOptions } from './types/options.d.js';
import { DriversResponse, DriverApiData } from './types/api/driver.d.js';
import { StatusType } from './enums/StatusType.js';
import { StatusesResponse, StatusApiData } from './types/api/status.d.js';
import { ConstructorStandingsResponse, ConstructorStandingApiData } from './types/api/constructor-standing.d.js';
...
declare class PendingRequest<TData extends AnyModel[], TResource extends ModelsKey<TData[number]> = ModelsKey<TData[number]>, TModel extends ModelsMap[TResource] = ModelsMap[TResource]> {
    ...
    constructor(api: Api, resource: TResource, options: AnyApiOptions, transform: (data: ResponsesMap[TResource]['MRData']) => TModel[]);
    /**
     * @since 3.0.0
     */
    get url(): string;
...
declare class Api {
    ...
    protected makePendingRequest<TData extends AnyModel[], TResource extends ModelsKey<TData[number]> = ModelsKey<TData[number]>, TModel extends ModelsMap[TResource] = ModelsMap[TResource]>(resource: TResource, transform: (data: ResponsesMap[TResource]['MRData']) => TModel[], options?: AnyApiOptions): PendingRequest<TData, TResource>;
